...
class Allocator {
  ...
  public:
    ...
    vk::Buffer allocateBuffer(const vk::BufferCreateInfo&, VmaMemoryUsage usage = VMA_MEMORY_USAGE_AUTO, VmaAllocationCreateFlags flags = VMA_ALLOCATION_CREATE_HOST_ACCESS_SEQUENTIAL_WRITE_BIT);
